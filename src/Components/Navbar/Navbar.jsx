                ...
                <div className="container flex 
                    ...
                    <div className="flex justify-between items-center gap-4 ">
                        ...
                        <div className="relative group hidden sm:block">
                            <button
                                className=" text-white border-none bg-gradient-to-r  from-primary to-secondary
                                px-4 py-1 rounded-full hover:bg-primary hover:text-white
